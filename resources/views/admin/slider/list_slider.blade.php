        ...
        <div class="panel panel-default">
            ...
            <div class="table-responsive">
              ...
              <?php
                                    ...
                                    ?>
                <a href="{{URL::to('/admin/unactive-slide/'.$slide->slider_id)}}"><span
                        class="fa-thumb-styling fa fa-thumbs-up"></span></a>
                <?php
                                    }else{
                                    ?>
                 <a href="{{URL::to('/admin/active-slide/'.$slide->slider_id)}}"><span
                ...
                <?php
                            ...
                            <td>
                                <a onclick="return confirm('Bạn có chắc là muốn xóa slide này ko?')"
                                   href="{{URL::to('/admin/delete-slide/'.$slide->slider_id)}}" class="active styling-edit"
                                   ui-toggle-class="">
